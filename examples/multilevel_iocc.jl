...
SASQ.add_subspace_relation(GeneralOrbital, ActiveOccupiedOrbital)
SASQ.add_subspace_relation(GeneralOrbital, ActiveVirtualOrbital)
SASQ.add_subspace_relation(GeneralOrbital, InactiveOrbital)
SASQ.add_subspace_relation(GeneralOrbital, InactiveOccupiedOrbital)
SASQ.add_subspace_relation(GeneralOrbital, InactiveVirtualOrbital)
